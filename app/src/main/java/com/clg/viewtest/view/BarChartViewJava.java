...
public class BarChartViewJava extends View {
    ...
    public BarChartViewJava(Context context) {
        this(context, null);
    }

    public BarChartViewJava(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BarChartViewJava(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
